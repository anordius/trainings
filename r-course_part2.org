...
2. Reshaping data
   ...
   3) ~dplyr~ package and related functions
   ...
   4) =tidyr= package other functions
   5) =skimr= for quick summary
   6) =janitor= for cleaning data
...
3. ~ggplot2~ for Data visuation
4. Basics of Regression Modelling in R (Cross-sectional data)
